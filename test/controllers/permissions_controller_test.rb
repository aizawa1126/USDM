...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { operation_id: @permission.operation_id, role_id: @permission.role_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { operation_id: @permission.operation_id, role_id: @permission.role_id } }
